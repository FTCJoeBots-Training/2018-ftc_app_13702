...
public class HardwareJoeBot2018 {
    ...
    //public DcMotor a daelbowMotor = null;
    ...
    static final double MainBucketMotor_StartPos = 20;
...
*/
    ...
    public void startPosMainBucketMotor () {
        if (MainBucketMotor.getCurrentPosition() <= 0) {
            MainBucketMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            MainBucketMotor.setTargetPosition(0);
        }
        if (MainBucketMotor.getCurrentPosition() >= 0) {
            MainBucketMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            MainBucketMotor.setTargetPosition(0);
    ...
    public void defaultPosMainBucketMotor () {
        if (MainBucketMotor.getCurrentPosition() <= 0) {
            MainBucketMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            MainBucketMotor.setTargetPosition(0);
        }
